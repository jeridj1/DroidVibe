...
export default function BenchScreen() {
  ...
  async function doCapture() {
    ...
    try {
      ...
      if (!opened) throw new Error('Could not open serial to the Pico. Check USB permission.');
      try {
        ...
        <View style={{ paddingHorizontal: 16 }}>
          ...
          {selectedMode === 'logic-analyzer' && <>
            ...
            <Card style={{ marginBottom: 12 }}>
              ...
              <Row style={{ marginBottom: 8 }}><Text style={{ color: palette.textMuted, fontSize: 12 }}>Samples:</Text><View style={{ flex: 1, marginLeft: 8 }}><TextInput style={{ borderWidth: 1, borderColor: 'rgba(150,150,150,0.3)', borderRadius: 8, padding: 6, color: palette.text, fontSize: 13 }} value={String(numSamples)} onChangeText={v => setNumSamples(parseInt(v) || 8192)} keyboardType="numeric" /></View></Row>

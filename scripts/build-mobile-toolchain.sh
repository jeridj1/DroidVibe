...
# The archive is created by a root container, so the runner cannot chmod it.
# It is already readable and can be split/uploaded directly from the output directory.
